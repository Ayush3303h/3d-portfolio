...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "ayush.sahu2024@nst.rishihood.edu.in",
    href: "mailto:ayush.sahu2024@nst.rishihood.edu.in",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/ayush-sahu-a44904323/",
    content: "/ayush-sahu-a44904323",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Ayush3303h",
    content: "/Ayush3303h",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Ayush</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Ayush, a Comp. Sci. Engineer with 6 months experience in Devlopment, DevOps and 
              Database management with hands-on experience in deploying & automating workflows, and 
              collaborating with multiple clients. Strong analytical skills,effective communication,
