...
const projects: Project[] = [
  ...
  { 
    ...
    title: "QrFoodOdering",
    src: "/assets/projects-screenshots/QrFoodOdering/3.png",
    screenshots: ["1.png", "2.png", "3.png","4.png","5.png"],
    live: "https://streake.in/recruiterscafe?table=12",
    github:"https://github.com/Ayush3303h/Qrodering",
    skills: {
  ...
  { 
    ...
    title: "UrbanHealthScope: FSTE Hackhathon Project",
    src: "/assets/projects-screenshots/UrbanHealthScope/1.png",
    ...
    live: "https://urban-health-scope.vercel.app/",
    github: "https://github.com/Ayush3303h/UrbanHealthScope",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
          UrbanHealthScope: FSTE Hackhathon Project
          </TypographyP>
          <TypographyP className="font-mono ">
          A responsive health-data visualization app built with React.js and Tailwind CSS, featuring interactive charts, clean component architecture, and optimized client-side rendering for fast performance.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/UrbanHealthScope/1.png`,
              `${BASE_PATH}/UrbanHealthScope/2.png`,
              `${BASE_PATH}/UrbanHealthScope/3.png`,
              `${BASE_PATH}/UrbanHealthScope/4.png`,
              `${BASE_PATH}/UrbanHealthScope/5.png`,
              `${BASE_PATH}/UrbanHealthScope/6.png`,
              `${BASE_PATH}/UrbanHealthScope/7.png`,
              `${BASE_PATH}/UrbanHealthScope/8.png`,
              `${BASE_PATH}/UrbanHealthScope/9.png`,
              `${BASE_PATH}/UrbanHealthScope/10.png`,
              `${BASE_PATH}/UrbanHealthScope/11.png`,
              `${BASE_PATH}/UrbanHealthScope/12.png`,
              `${BASE_PATH}/UrbanHealthScope/13.png`,
              `${BASE_PATH}/UrbanHealthScope/14.png`,
              `${BASE_PATH}/UrbanHealthScope/15.png`,
  ...
  { 
    ...
    src: "/assets/projects-screenshots/BMI/1.png",
    screenshots: ["assets/projects-screenshots/BMI/1.png"],
    live: "https://bmi-green-zeta.vercel.app/",
    github:"https://github.com/Ayush3303h/BMI",
    skills: {
      frontend: [
        PROJECT_SKILLS.html,
        PROJECT_SKILLS.css,
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
          A simple tool that calculates Body Mass Index (BMI) based on height and weight, helping users understand their health category.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
